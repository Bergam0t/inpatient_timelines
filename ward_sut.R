...
plotSingleClientJourney <- function(dataset) {
  #' Expects a dataset containing the following columns
  #' Client ID
  #' AdmissionDate
  #' DischargeDate
  #' Ward
  ...
  plot_df <- client_stay_data_final |> 
    select(ClientID, Ward, Specialty, AdmissionDate, DischargeDate) |> 
    pivot_longer(!c(ClientID, Ward, Specialty))
